...
angular.module('blankonConfig', [])
    ...
    .factory('settings', ['$rootScope', function($rootScope) {
        var baseURL ='/medical2',
            settings = {
                baseURL                 : baseURL,
                baseURLCI               : baseURL+'/ci.php/',
    ...
    .config(function($stateProvider, $locationProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('agenda', {
                url: '/agenda',
                templateUrl: 'ci.php/agenda/ver_agenda',
                data: {
                    pageTitle: 'AGENDA',
                    pageHeader: {
                        icon: 'fa fa-calendar',
                            ...
                            [
                                {
                                    insertBefore: '#load_css_before',
                                    files: [
                                        pluginPath+'/helpers/demo.css?v=2279',
                                        pluginPath+'/helpers/media/layout.css?v=2279',
                                        pluginPath+'/helpers/media/elements.css?v=2279',
                                        pluginPath+'/themes/navigator_8.css?v=2279',
                                        pluginPath+'/chosen_v1.2.0/chosen.min.css'
                                        //pluginPath+'/bootstrap/css/bootstrap-combined.min.css'
                                    ]
                                },
                                {
                                    name: 'blankonApp.agenda',
                                    files: [
                                        //pluginPath+'/helpers/jquery-1.12.2.min.js',
                                        //pluginPath+'/bootstrap-datepicker-vitalets/js/locales/bootstrap-datepicker.es.js',
                                        pluginPath+'/chosen_v1.2.0/chosen.jquery.min.js',
                                        pluginPath+'/daypilot/daypilot-all.min.js?v=2279',
                                        'js/modules/app/agenda.js'
                                    ]
                                }
                            ]
                        );
            ...
            .state('pacientexxx', {
                url: '/pacientexxx',
                templateUrl: 'ci.php/paciente/lista',
                data: {
                    pageTitle: 'PACIENTE',
                    pageHeader: {
                        icon: 'fa fa-group',
                    ...
                    deps: ['$ocLazyLoad', 'settings', function($ocLazyLoad, settings) {
                        ...
                        return $ocLazyLoad.load( // you can lazy load files for an existing module
                            [
                                ...
                                {
                                    name: 'blankonApp.paciente',
                                    files: [
                                        //pluginPath+'/helpers/jquery-1.12.2.min.js',
                                        //pluginPath+'/daypilot/daypilot-all.min.js?v=2279',
                                        'js/modules/app/paciente.js'
                                    ]
                                }
                            ]
                        );
            ...
            .state('pageProfile', {
                ...
                data: {
                    ...
                    breadcrumbs: [
                        {title: 'Paciente'},{title: 'Datos Generales'}
                    ]
                }
            })
            // =========================================================================
            // PROFILE - IMAGENES
            // =========================================================================
            .state('pageProfileImage', {
                //url: '/page-profile',
                url: '/paciente-view-imagenes',
                templateUrl: 'views/pages/page-profile-imagenes.html',
                data: {
                    pageTitle: 'PACIENTE',
                    pageHeader: {
                        icon: 'fa fa-male',
            ...
            // PROFILE - CITAS
            // =========================================================================
            .state('pageProfileCita', {
                //url: '/page-profile',
                url: '/paciente-view-citas',
                templateUrl: 'views/pages/page-profile-citas.html',
                data: {
                    pageTitle: 'PACIENTE',
                    pageHeader: {
                        icon: 'fa fa-male',
            ...
            // PROFILE - ATENCION
            // =========================================================================
            .state('pageProfileAtencion', {
                //url: '/page-profile',
                url: '/paciente-view-atencion',
                templateUrl: 'views/pages/page-profile-atencion.html',
                data: {
                    pageTitle: 'PACIENTE',
                    pageHeader: {
                        icon: 'fa fa-male',
                    ...
                    breadcrumbs: [
                        {title: 'Paciente'},{title: 'Atención Médica'}
                    ]
                }
            })
            // =========================================================================
            // PROFILE - PRESUPUESTO
            // =========================================================================
            .state('pageProfilePresupuesto', {
                //url: '/page-profile',
                url: '/paciente-view-presupuesto',
                templateUrl: 'views/pages/page-profile-presupuesto.html',
                data: {
                    pageTitle: 'PACIENTE',
                    pageHeader: {
                        icon: 'fa fa-male',
                    ...
                    breadcrumbs: [
                        {title: 'Paciente'},{title: 'Presupuesto'}
                    ]
                }
            })
            // =========================================================================
            // PROFILE - DOCUMENTOS
            // =========================================================================
            .state('pageProfileDocumentos', {
                //url: '/page-profile',
                url: '/paciente-view-documentos',
                templateUrl: 'views/pages/page-profile-documentos.html',
                data: {
                    pageTitle: 'PACIENTE',
                    pageHeader: {
                        icon: 'fa fa-male',
                    ...
                    breadcrumbs: [
                        {title: 'Paciente'},{title: 'Documentos'}
                    ]
                },
                resolve: {
                    deps: ['$ocLazyLoad', 'settings', function($ocLazyLoad, settings) {
            ...
            .state('pageProfile2', {
                //url: '/page-profile',
                url: '/medico-view',
                templateUrl: 'views/pages/page-profile2.html',
                data: {
                    pageTitle: 'ESPECIALISTA',
                    pageHeader: {
                        icon: 'fa fa-male',
                    ...
                    breadcrumbs: [
                        {title: 'Odontologo'},{title: 'Datos Generales'}
                    ]
                }
            })
            ...
            .state('tableDefault', {
                ...
                data: {
                    ...
                    pageHeader: {
                        icon: 'fa fa-group',
                        title: 'Pacientes',
                        subtitle: 'Lista General'
                    },
                    breadcrumbs: [
                        {title: 'Pacientes'},{title: 'Lista General'}
                    ]
                },
            ...
            .state('tableDefault2', {
                //url: '/table-default',
                url: '/medico',
                templateUrl: 'views/tables/table-default2.html',
                data: {
                    ...
                    breadcrumbs: [
                        {title: 'Odontologos'},{title: 'Lista General'}
                    ]
                },
                controller: 'TableDefaultCtrl',
                resolve: {
            ...
            .state('tableDatatable', {
                ...
                data: {
                    ...
                    pageHeader: {
                        icon: 'fa fa-table',
                        title: 'Cajas',
                        subtitle: 'Resumen de Cajas'
                    },
                    breadcrumbs: [
                        {title: 'Cajas'},{title: 'Resumen de Cajas'}
                    ]
                },
                resolve: {
                    deps: ['$ocLazyLoad', 'settings', function($ocLazyLoad, settings) {
            ...
            // TABLE DATATABLE 2
            // =========================================================================
            .state('tableDatatable2', {
                //url: '/table-datatable',
                url:'/recaudacion',
                templateUrl: 'views/tables/table-datatable2.html',
                data: {
                    pageTitle: 'RECAUDACION',
                    pageHeader: {
                        icon: 'fa fa-table',
                        title: 'Recaudación',
                        subtitle: 'Resumen de Ventas Sedes'
                    },
                    breadcrumbs: [
                        {title: 'Recaudación'},{title: 'Resumen de Ventas'}
                    ]
                },
                resolve: {
                    deps: ['$ocLazyLoad', 'settings', function($ocLazyLoad, settings) {
    ...
    // Init app run
    .run(["$rootScope", "settings", "$state","$location","$cookies","AuthenticationService", "$stateParams", function($rootScope, settings, $state, $location,$cookies,AuthenticationService, $stateParams) {
